...
*   Developed and Maintaining both Backend and app of Rust Book. Developed with **Kotlin** and **Jetpak Compose**. This app support translation of Rust Book in 18 languages. Also there have more useful features. Developed to help beginners of Rust learners. Have over **11.5k** download with **4.6/5** Rating on Google Play Store. Here you will find the app. [Link](https://play.google.com/store/apps/details?id=com.rust_book.example)

*   Developed Rust Doc (Everything) app with all the resources of Rust documentation. Totally offline and have features as like Rust Book. Have **2.25k** download with **4.7/5** rating on Google Play Store. Developed for Rust developer. Here is the [link](https://play.google.com/store/apps/details?id=com.rust_doc.md_ismail_hosen) you find the app.

*   I have **2** more application on Play store. To explore all apps, you can find my [list](https://play.google.com/store/apps/developer?id=MD.+Ismail+Hosen) here.
...
*   Actively Building and Maintaining my own apps.
*   Build industry level apps for Radiant Pharmaceuticals.
