...
export default function AdminPage() {
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    const handleArrayChange = (section: "skills" | "projects" | "experience" | "achievements", index: number, field: string | null, value: any) => {
        setData((prev: PortfolioData) => {
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    const handleMoveUp = (section: "skills" | "projects" | "experience" | "achievements", index: number) => {
        if (index === 0) return;
        setData((prev: PortfolioData) => {
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            const newArray = [...prev[section]] as any[];
    ...
    const handleMoveDown = (section: "skills" | "projects" | "experience" | "achievements", index: number) => {
        setData((prev: PortfolioData) => {
